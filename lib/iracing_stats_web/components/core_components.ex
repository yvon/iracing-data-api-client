defmodule IracingStatsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IracingStatsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IracingStatsWeb.Gettext, "errors", msg, opts)
    end
  end
